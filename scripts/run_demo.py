...
from src.reddiff_gp import build_gp_algo
from src.reddiff_gp.dataset import build_loader
from src.reddiff_gp import build_model
from src.reddiff_gp.score_estimator import ReverseDiffusionModel
...
def main(cfg: DictConfig):
    ...
    for batch_idx, (x, y, info) in enumerate(loader):
        ...
        xt_s, mu, mu_list, _, _ = algo.sample(x, y, ts, **info)
        ...
        logger.info(f"Saved mu_list to {mu_history_file}")
